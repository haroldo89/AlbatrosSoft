IF exists (select * from sysobjects where id = object_id(N'[dbo].[actualizarArchivos]') and OBJECTPROPERTY(id, N'IsProcedure') = 1)
drop procedure [dbo].[actualizarArchivos]
GO
/*
